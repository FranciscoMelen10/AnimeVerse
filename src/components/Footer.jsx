  ...
  return (
    <footer className="flex justify-between w-full max-w-[1000px] gap-4 p-6 font-medium text-color_100 mt-5 text-[20px] max-md:flex-col-reverse max-md:items-center max-md:text-center">
      ...
      <picture className="flex gap-4">
        {/* Enlace de Facebook */}
        <Link href="https://www.facebook.com/chicoyfrancisco.melendez/" className="facebook">
          <svg
            className="nc gc"
        ...
        {/* Enlace de Instagram */}
        <Link href="https://www.instagram.com/coooooooooooyyyyyyy/" className="instagram">
          <svg className="nc gc" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#b0b0b0"             width={30}
            height={30} >
            <path
        ...
        {/* Enlace de GitHub */}
        <Link href="https://github.com/FranciscoMelen10" className="github">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width={30}
